                ...
                for (var a = 0; n > a; a++) if (v.State.calls[a]) {
                    ...
                    for (var m = Math.min((e - h) / d.duration, 1), b = 0, x = s.length; x > b; b++) {
                        ...
                        if (r(S)) {
                            ...
                            for (var M in d.visibility !== i && "hidden" !== d.visibility && y.setPropertyValue(S, "visibility", d.visibility), k) if ("element" !== M) {
                                ...
                                if (T.currentValue = P, "tween" === M) g = P; else {
                                    if (y.Hooks.registered[M]) {
                                        var _ = y.Hooks.getRoot(M), D = r(S).rootPropertyValueCache[_];
                            ...
                            d.mobileHA && r(S).transformCache.translate3d === i && (r(S).transformCache.translate3d = "(0px, 0px, 0px)", C = !0), C && y.flushTransformCache(S)
                        }
                    }
            ...
            var x = function () {
                ...
                function o() {
                    function t(t) {
                        function h(t, e) {
                            var n = i, a = i, r = i;
                            return f.isArray(t) ? (n = t[0], !f.isArray(t[1]) && /^[\d-]/.test(t[1]) || f.isFunction(t[1]) || y.RegEx.isHex.test(t[1]) ? r = t[1] : (f.isString(t[1]) && !y.RegEx.isHex.test(t[1]) || f.isArray(t[1])) && (a = e ? t[1] : s(t[1], u.duration), t[2] !== i && (r = t[2]))) : n = t, e || (a = a || u.easing), f.isFunction(n) && (n = n.call(o, C, S)), f.isFunction(r) && (r = r.call(o, C, S)), [n || 0, a, r]
                        }
                        ...
                        d.element && (y.Values.addClass(o, "velocity-animating"), R.push(d), "" === u.queue && (r(o).tweensContainer = d, r(o).opts = u), r(o).isAnimating = !0, C === S - 1 ? (v.State.calls.push([R, m, u, null, T.resolver]), !1 === v.State.isTicking && (v.State.isTicking = !0, l())) : C++)
                    }
                            ...
                            if (!c.isPlainObject(b) || f.isEmptyObject(b)) {
                                if (f.isString(b) && v.Redirects[b]) {
                                    ...
                                    return !0 === O.backwards && (m = c.extend(!0, [], m).reverse()), c.each(m, function (t, e) {
                                        parseFloat(O.stagger) ? O.delay = _ + parseFloat(O.stagger) * t : f.isFunction(O.stagger) && (O.delay = _ + O.stagger.call(e, t, S)), O.drag && (O.duration = parseFloat(I) || (/^(callout|transition)/.test(b) ? 1e3 : g), O.duration = Math.max(O.duration * (O.backwards ? 1 - t / S : (t + 1) / S), .75 * O.duration, 200)), v.Redirects[b].call(e, e, O || {}, t, S, m, T.promise ? T : i)
                                    }), t()
                                }
                ...
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    dataElementType: a.Arc, linkScales: r.noop, getRingIndex: function (t) {
                        ...
                        if (f < 2 * Math.PI) {
                            ...
                            u = Math.min(s / M.width, l / M.height), c = {x: -.5 * (C.x + S.x), y: -.5 * (C.y + S.y)}
                        }
                ...
                defaults: {}, addBox: function (t, e) {
                    ...
                    if (t) {
                        ...
                        var v = e - l - u, b = n - c - d, y = b / 2, x = (e - v / 2) / (h.length + f.length),
                            w = (n - y) / (p.length + g.length), k = v, S = b, C = [];
                        i.each(h.concat(f, p, g), function (t) {
                            var e, n = t.isHorizontal();
                            n ? (e = t.update(t.fullWidth ? v : k, w), S -= e.height) : (e = t.update(x, S), k -= e.width), C.push({
                                horizontal: n,
                                minSize: e,
                                box: t
                            })
                        ...
                        var z = l + O, N = c + L;
                        i.each(h.concat(p), W), z += k, N += S, i.each(f, W), i.each(g, W), t.chartArea = {
                            left: I,
                            top: D,
                            right: I + k,
                            bottom: D + S
                ...
                fit: function () {
                    ...
                    if (a.display && h) {
                        ...
                        if (f) {
                            ...
                            0 !== t.labelRotation ? (t.paddingLeft = "bottom" === i.position ? k * C + 3 : k * y + 3, t.paddingRight = "bottom" === i.position ? k * y + 3 : k * M + 3) : (t.paddingLeft = C / 2 + 3, t.paddingRight = M / 2 + 3)
                ...
                draw: function (t) {
                    ...
                    if (n.display) {
                        var a = e.ctx, o = i.global, s = n.ticks.minor, u = n.ticks.major || s, h = n.gridLines,
                            ...
                            k = r.valueOrDefault(f.fontColor, o.defaultFontColor), S = c(f),
                        ...
                        if (r.each(m, function (i, a) {
                            if (!r.isNullOrUndef(i.label)) {
                                var u, c, d, f, v, b, y, x, k, S, C, F, O, L, R = i.label;
                                ...
                                if (g) {
                                    ...
                                    W < e.left && (c = "rgba(0,0,0,0)"), W += r.aliasPixel(u), O = e.getPixelForTick(a) + s.labelOffset, v = y = k = C = W, b = _, x = D, S = t.top, F = t.bottom + T
                                } else {
                                    ...
                                    j < e.top && (c = "rgba(0,0,0,0)"), j += r.aliasPixel(u), L = e.getPixelForTick(a) + s.labelOffset, v = A, y = I, k = t.left, C = t.right + T, b = x = S = F = j
                                }
                                P.push({
                                    tx1: v,
                                    ty1: b,
                            ...
                            var F, O, L = 0, R = d(f) / 2;
                            if (g) F = e.left + (e.right - e.left) / 2, O = "bottom" === n.position ? e.bottom - R - C.bottom : e.top + R + C.top; else {
            ...
            (e.exports = a.extend({
                initialize: function () {
                    ...
                    if (g.length) {
                        ...
                        var S = [];
                        for (e = 0, n = g.length; e < n; ++e) S.push((i = g[e], a = void 0, s = void 0, void 0, void 0, a = i._xScale, s = i._yScale || i._scale, l = i._index, u = i._datasetIndex, {
                        ...
                        }), p.title = d.getTitle(S, m), p.beforeBody = d.getBeforeBody(S, m), p.body = d.getBody(S, m), p.afterBody = d.getAfterBody(S, m), p.footer = d.getFooter(S, m), p.x = Math.round(x.x), p.y = Math.round(x.y), p.caretPadding = h.caretPadding, p.labelColors = w, p.labelTextColors = k, p.dataPoints = S, b = function (t, e, n, i) {
            ...
            var u = a.extend({
                initialize: function (t) {
                    ...
                    if (m ? (g.width = t.maxWidth, g.height = a ? 10 : 0) : (g.width = a ? 10 : 0, g.height = t.maxHeight), a) if (o.font = f, m) {
                        ...
                        var y = n.padding, x = t.columnWidths = [], w = n.padding, k = 0, S = 0, C = c + y;
                        r.each(t.legendItems, function (t, e) {
                            var i = l(n, c) + c / 2 + o.measureText(t.text).width;
                            S + C > g.height && (w += k + n.padding, x.push(k), k = 0, S = 0), k = Math.max(k, i), S += C, p[e] = {
                                left: 0,
                                top: 0,
                                width: i,
                                height: c
            ...
            e.exports = function () {
                var t = i.extend({
                    getLabels: function () {
                        ...
                        var c = i.height / r, d = c * (e - i.minIndex);
