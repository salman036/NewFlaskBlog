...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    return function (t, e, i, n) {
        ...
        function r(t, i, n, o) {
            ...
            var w = b ? new Float32Array(v) : new Array(v), k = !1, C = function (e) {
                ...
                for (var o = 0; i > o; o++) if (v.State.calls[o]) {
                    ...
                    for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
                        ...
                        if (a(C)) {
                            ...
                            for (var M in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(C, "visibility", d.visibility), k) if ("element" !== M) {
                                var T, P = k[M], I = p.isString(P.easing) ? v.Easings[P.easing] : P.easing;
                                if (1 === g) T = P.endValue; else {
                                    var A = P.endValue - P.startValue;
                                    if (T = P.startValue + A * I(g, d, A), !f && T === P.currentValue) continue
                                }
                                if (P.currentValue = T, "tween" === M) m = T; else {
                                    if (b.Hooks.registered[M]) {
                                        var O = b.Hooks.getRoot(M), _ = a(C).rootPropertyValueCache[O];
        ...
        if (!(7 >= d)) {
            ...
            var x = function () {
                        ...
                        if ("scroll" === T) {
                            ...
                            c.container ? p.isWrapped(c.container) || p.isNode(c.container) ? (c.container = c.container[0] || c.container, M = (x = c.container["scroll" + I]) + u(r).position()[I.toLowerCase()] + A) : c.container = null : (x = v.State.scrollAnchor[v.State["scrollProperty" + I]], k = v.State.scrollAnchor[v.State["scrollProperty" + ("Left" === I ? "Top" : "Left")]], M = u(r).offset()[I.toLowerCase()] + A), d = {
                                scroll: {
                                    ...
                                    unitType: "",
                                    easing: c.easing,
                                    scrollData: {container: c.container, direction: I, alternateValue: k}
                                }, element: r
                            ...
                            for (var E in a(r).tweensContainer && !0 === a(r).isAnimating && (O = a(r).tweensContainer), u.each(y, function (t, e) {
                                ...
                                if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
                                    ...
                                    if (V = (H = f(E, V))[0], B = H[1], F = (H = f(E, F))[0].replace(/^([+-\/*])=/, function (t, e) {
                                        return Y = e, ""
                                    }), j = H[1], V = parseFloat(V) || 0, F = parseFloat(F) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(E) ? (F /= 100, j = "em") : /^scale/.test(E) ? (F /= 100, j = "") : /(Red|Green|Blue)$/i.test(E) && (F = F / 100 * 255, j = "")), /[\/*]/.test(Y)) j = B; else if (B !== j && 0 !== V) if (0 === F) j = B; else {
                                        o = o || m();
                ...
                if (p.isWrapped(this) ? (d = !1, f = 0, g = this, h = this) : (d = !0, f = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
                    ...
                    var T, P = {promise: null, resolver: null, rejecter: null};
                        ...
                        default:
                            if (!u.isPlainObject(y) || p.isEmptyObject(y)) {
                                if (p.isString(y) && v.Redirects[y]) {
                                    var A = (E = u.extend({}, w)).duration, O = E.delay || 0;
                    ...
                    if (u.each(g, function (t, e) {
                        p.isNode(e) && r.call(e)
                    }), (E = u.extend({}, v.defaults, w)).loop = parseInt(E.loop), D = 2 * E.loop - 1, E.loop) for (var $ = 0; D > $; $++) {
        ...
        1: [function (t, e, i) {
            ...
            n._set("doughnut", {
                ...
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    dataElementType: o.Arc, linkScales: a.noop, getRingIndex: function (t) {
                        ...
                        var y = t._model, b = t.custom || {}, x = a.valueAtIndexOrDefault,
            ...
            n._set("polarArea", {
                ...
                t.controllers.polarArea = t.DatasetController.extend({
                    dataElementType: o.Arc, linkScales: a.noop, update: function (t) {
                        ...
                        var y = this.chart.options.elements.arc, b = t.custom || {}, x = a.valueAtIndexOrDefault,
                            w = t._model;
                ...
                defaults: {}, addBox: function (t, e) {
                    ...
                    if (t) {
                        ...
                        var v = e - l - c, y = i - u - d, b = y / 2, x = (e - v / 2) / (h.length + p.length),
                            w = (i - b) / (f.length + m.length), k = v, C = y, S = [];
            ...
            n._set("scale", {
                ...
                fit: function () {
                    ...
                    if (o.display && h) {
                        var v = a.longestText(t.ctx, f.font, i, t.longestTextCache), y = a.numberOfLabelLines(i),
                ...
                draw: function (t) {
                    ...
                    if (i.display) {
                        var o = e.ctx, r = n.global, s = i.ticks.minor, c = i.ticks.major || s, h = i.gridLines,
                            ...
                            b = a.valueOrDefault(c.fontColor, r.defaultFontColor), x = u(c),
                            ...
                            P = e.options.gridLines.lineWidth, I = "right" === i.position ? e.left : e.right - P - w,
                        ...
                        if (a.each(g, function (n, o) {
                            if (!a.isNullOrUndef(n.label)) {
                                ...
                                var $ = "middle", F = "middle", W = s.padding;
                                if (m) {
                                    var V = w + W;
                            ...
                            var D, E, L = 0, R = d(p) / 2;
                            if (m) D = e.left + (e.right - e.left) / 2, E = "bottom" === i.position ? e.bottom - R - S.bottom : e.top + R + S.top; else {
                                var $ = "left" === i.position;
                        ...
                        if (h.drawBorder) {
                            ...
                            var F = e.left, W = e.right + P, V = e.top, z = e.bottom + P, N = a.aliasPixel(o.lineWidth);
            ...
            (e.exports = o.extend({
                initialize: function () {
                    ...
                    var e, i, n, o, s, l, c, d = this, h = d._options, p = d._model, f = d._model = u(h), m = d._active,
                        g = d._data, v = {xAlign: p.xAlign, yAlign: p.yAlign}, y = {x: p.x, y: p.y},
            ...
            var c = o.extend({
                initialize: function (t) {
                    ...
                    if (g ? (m.width = t.maxWidth, m.height = o ? 10 : 0) : (m.width = o ? 10 : 0, m.height = t.maxHeight), o) if (r.font = p, g) {
                        ...
                        var b = i.padding, x = t.columnWidths = [], w = i.padding, k = 0, C = 0, S = u + b;
                    ...
                    setDimensions: function () {
                        ...
                        this.options.pointLabels.display ? function (t) {
                            ...
                            for (e = 0; e < m; e++) {
                                ...
                                var g = t.getIndexAngle(e), v = o.toDegrees(g) % 360, y = c(v, n.x, i.w, 0, 180),
                        ...
                        if (i.display) {
                            var c = t.ctx, p = this.getIndexAngle(0), f = r(a.fontSize, e.defaultFontSize),
                                m = r(a.fontStyle, e.defaultFontStyle), g = r(a.fontFamily, e.defaultFontFamily),
            ...
            function y(t, e, i, o) {
                var r, s = o.time, l = s.unit || function (t, e, i, n) {
                        ...
                        return d[s - 1]
                    }(s.minUnit, t, e, i), h = v(l), p = a.valueOrDefault(s.stepSize, s.unitStepSize),
                    f = "week" === l && s.isoWeekday, m = o.ticks.major.enabled, g = u[l], y = n(t), b = n(e), x = [];
            ...
            e.exports = function () {
                var t = r.extend({
                    initialize: function () {
                        ...
                        var t, e, i, o, r, s, u = this, d = u.chart, f = u.options.time, m = f.unit || "day", v = c,
                            y = l, b = [], x = [], w = [];
...
!function (t) {
    ...
    t(document).on("click.card", ".card", function (e) {
        if (t(this).find(".card-reveal").length) {
            var i = t(e.target), n = i.is(".card-reveal .card-title"), o = i.is(".card-reveal .card-title i"),
...
$(".smooth-scroll").on("click", "a", function () {
    ...
    t.fn.scrollTo = function (e) {
        ...
        this.each(function () {
            var i = t(this), n = t.extend({}, t.fn.dropdown.defaults, e), o = !1,
            ...
            function s(e) {
                ...
                var s = window.innerHeight, l = i.innerHeight(), c = i.offset().left,
                    u = i.offset().top - t(window).scrollTop(), d = n.alignment, h = 0, p = 0, f = 0;
                !0 === n.belowOrigin && (f = l);
                var m = 0, g = i.parent();
...
function dropdownEffectData(t) {
    var e = "fadeIn", i = "fadeOut", n = $(t), o = $(".dropdown-menu", t), a = n.parents("ul.nav");
...
dropdownSelectors.on({
    ...
    var e = 240, i = 1440, n = 300, o = 200, a = 50, r = 200, s = "easeOutQuad", l = "easeOutCubic", c = !0, u = !1,
        d = function () {
            function d(h, p) {
            ...
            return _createClass(d, [{
                ...
                key: "touchmoveEventHandler", value: function (t) {
                    if ("touchmove" === t.type) {
                ...
                key: "touchendEventHandler", value: function (t) {
                    if ("touchend" === t.type) {
                ...
                key: "panendEventHandler", value: function (t) {
                    if ("touch" === t.gesture.pointerType) {
                        var e = t.gesture.velocityX, i = t.gesture.center.x, n = i - this.options.menuWidth,
                ...
                key: "setMenuTranslation", value: function () {
                    var e = this;
                    "left" === this.options.edge ? (this.$menu.css("transform", "translateX(-100%)"), this.$dragTarget.css({left: 0})) : (this.$menu.addClass("right-aligned").css("transform", "translateX(100%)"), this.$dragTarget.css({right: 0})), this.$menu.hasClass("fixed") && (window.innerWidth > this.options.breakpoint && this.$menu.css("transform", "translateX(0)"), t(window).resize(function () {
                        if (window.innerWidth > e.options.breakpoint) e.$sidenavOverlay.length ? e.removeMenu(!0) : e.$menu.css("transform", "translateX(0%)"); else if (!1 === e.menuOut) {
    ...
    t(document).on("change", i, function () {
        ...
        var a = t(this), r = a.siblings(".thumb"), s = a.outerWidth();
    ...
    t(document).on("change", '.file-field input[type="file"]', function (e) {
        var i = t(e.target), n = i.closest(".file-field").find("input.file-path"), o = i[0].files, a = [];
    ...
    var e, i = function () {
        ...
        return _createClass(e, [{
            ...
            key: "debounce", value: function (t, e, i) {
                var n;
                return function () {
            ...
            key: "buildSingleOption", value: function (e, i) {
                var n = e.is(":disabled") ? "disabled" : "", o = "optgroup-option" === i ? "optgroup-option" : "",
                    a = e.data("icon"), r = e.data("fas") ? '<i class="fas fa-'.concat(e.data("fas"), '"></i> ') : "",
                    s = e.attr("class"), l = a ? '<img alt="" src="'.concat(a, '" class="').concat(s, '">') : "",
            ...
            key: "_onMaterialSelectKeydown", value: function (e) {
                var i = t(e.target), n = e.which === this.keyCodes.tab, o = e.which === this.keyCodes.esc,
            ...
            key: "_handleLetterKey", value: function (e) {
                var i = this, n = "", o = String.fromCharCode(e.which).toLowerCase(),
    ...
    function M(t, e) {
        var i, o, r = n(S), l = r.find(".clockpicker-plate"), c = r.find(".picker__holder"),
            ...
            P = r.find(".clockpicker-am-pm-block"), I = "INPUT" === t.prop("tagName"), A = I ? t : t.find("input"),
            O = (A.prop("type"), n("label[for=" + A.attr("id") + "]")), _ = this;
        ...
        if (e.twelvehour) for (E = 0; E < 12; E += e.hourstep) L = F.clone(), R = E / 6 * Math.PI, $ = b, L.css("font-size", "140%"), L.css({
            left: y + Math.sin(R) * $ - w,
            top: y - Math.cos(R) * $ - w
        }), L.html(0 === E ? 12 : E), p.append(L), L.on(u, z); else for (E = 0; E < 24; E += e.hourstep) {
        ...
        for (E = 0; E < 60; E += V) for (E = 0; E < 60; E += 5) L = F.clone(), R = E / 30 * Math.PI, L.css({
            left: y + Math.sin(R) * b - w,
            top: y - Math.cos(R) * b - w
        }), L.css("font-size", "140%"), L.html(g(E)), M.append(L), L.on(u, z);

        function z(t, i) {
            var n = l.offset(), o = /^touch/.test(t.type), r = n.left + y, c = n.top + y,
        ...
        if (l.on(u, function (t) {
            ...
            var N = r.find(".clockpicker-canvas"), H = f("svg");
    ...
    M.DEFAULTS = {
        ...
        var e = this.currentView, i = this[e], n = "hours" === e, o = i * (Math.PI / (n ? 6 : 30)),
            a = n && i > 0 && i < 13 ? x : b, r = Math.sin(o) * a, l = -Math.cos(o) * a, c = this;
        ...
        var a, r, l = Math.atan2(t, -e), c = "hours" === this.currentView, u = Math.sqrt(t * t + e * e),
            d = this.options, h = c && u < (b + x) / 2, f = h ? x : b;
        if (a = c ? d.hourstep / 6 * Math.PI : d.minutestep / 30 * Math.PI, d.twelvehour && (f = b), l < 0 && (l = 2 * Math.PI + l), l = (r = Math.round(l / a)) * a, c ? (r *= d.hourstep, d.twelvehour || !h != r > 0 || (r += 12), d.twelvehour && 0 === r && (r = 12), 24 === r && (r = 0)) : 60 === (r *= d.minutestep) && (r = 0), c ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : r % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"), this[this.currentView] !== r && p && this.options.vibrate && (this.vibrateTimer || (navigator[p](10), this.vibrateTimer = setTimeout(n.proxy(function () {
            ...
            var m = Math.sin(l) * f, v = -Math.cos(l) * f;
        ...
        var t = this.input.prop("value"), e = this.hours, i = ":" + g(this.minutes);
    ...
    return function (t, e, i, n) {
        ...
        o.extend(r, n);
        var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, C, S, M, T, P, I, A, O, _, D, E, L, R, $, F, W, V, z, N, H,
            ...
            le = 0, ce = {x: 0, y: 0}, ue = {x: 0, y: 0}, de = {x: 0, y: 0}, he = function (t, e) {
                ...
                var c = -1;
                if (0 === l && (B = !1, o.unbind(window, p, a), pe(), K ? c = 0 : -1 !== le && (c = Mt() - le)), le = 1 === l ? Mt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", K && 2 > l && (K = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Z = null, q || X || et || H) if (Ut(), z || (z = Oe()), z.calculateSwipeSpeed("x"), H) if (xe() < r.verticalDragRange) a.close(); else {
                    var u = ut.y, d = at;
        ...
        var ei, ii, ni, oi, ai, ri, si, li, ci, ui, di, hi, pi = {history: !0, galleryUID: 1}, fi = function () {
            ...
            if (r.galleryPIDs) {
                var a = e.pid;
                for (e.pid = 0, i = 0; i < $e.length; i++) if ($e[i].pid === a) {
                    e.pid = i;
                    break
                }
    ...
    return function (t, e) {
        ...
        x.init = function () {
            e.extend(t.options, S, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), d = t.listen, function () {
                var t;
            ...
            this.$document.on("click", this.selectors.chips, function (i) {
                ...
                if (!t(i.target).is("input, textarea")) {
                    var n = e.$document.find(e.selectors.chip + e.selectors.selectedChip),
                        o = n.closest(e.selectors.chips), a = n.siblings(e.selectors.chip).length;
                    if (n.length) {
                        var r = i.which === e.keyCodes.backspace, s = i.which === e.keyCodes.delete,
                            l = i.which === e.keyCodes.arrowLeft, c = i.which === e.keyCodes.arrowRight;
                ...
                var n = t(i.target), o = n.closest(e.selectors.chips), a = o.data("index"),
...
!function (t) {
    ...
    var e = {}, i = "", n = "", o = "#ced4da", a = "1px solid #4285f4", r = "1px solid #ced4da",
            ...
            return _createClass(c, [{
                ...
                key: "inputKeyupData", value: function () {
                    ...
                    this.$input.on("keyup", function (i) {
                        var n = e.$input.val();
                        if (e.$autocompleteWrap.empty(), n.length) for (var o in e.options.data) if (-1 !== e.options.data[o].toLowerCase().indexOf(n.toLowerCase())) {
